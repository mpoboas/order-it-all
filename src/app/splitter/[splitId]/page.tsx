...
export default function SplitDetailPage() {
        ...
        return (
            <div className="min-h-screen bg-[var(--bg-primary)]">
                ...
                <div className="text-center py-20">
                    ...
                    <button onClick={() => router.push('/splitter')} className="btn btn-primary px-6 py-2 mt-4">Voltar</button>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[var(--bg-primary)] pb-32 md:pb-8">
            <Header showBack title={split.name} subtitle={split.description || 'Divisão'} />
